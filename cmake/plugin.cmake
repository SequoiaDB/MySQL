...
MACRO(CONFIGURE_PLUGINS)
  SET(SDB_LIST sequoiadb spark)
  FILE(GLOB dirs_storage ${SQL_SOURCE_ROOT}/storage/*)
  FILE(GLOB dirs_plugin ${SQL_SOURCE_ROOT}/plugin/*)
  IF(WITH_RAPID)
    FILE(GLOB dirs_rapid_plugin ${SQL_SOURCE_ROOT}/rapid/plugin/*)
  ENDIF(WITH_RAPID)

  FOREACH(dir ${dirs_storage} ${dirs_plugin} ${dirs_rapid_plugin})
    SET(ASSOCIATED_WITH_SDB 0)
    FOREACH(SDB_LIST_ITEM ${SDB_LIST})
      IF (${dir} STREQUAL "${SQL_SOURCE_ROOT}/storage/${SDB_LIST_ITEM}")
        SET(STORAGE_${SDB_LIST_ITEM}_exists 1)
        SET(ASSOCIATED_WITH_SDB 1)
        BREAK()
      ENDIF()
    ENDFOREACH()

    IF(${ASSOCIATED_WITH_SDB})
      CONTINUE()
    ENDIF()
  ...
  FOREACH(IS_EXISTS ${SDB_LIST})
    IF(STORAGE_${IS_EXISTS}_exists)
      IF(EXISTS ${SQL_SOURCE_ROOT}/storage/${IS_EXISTS}/CMakeLists.txt)
        ADD_SUBDIRECTORY("${SQL_SOURCE_ROOT}/storage/${IS_EXISTS}")
      ENDIF()
    ENDIF()
  ENDFOREACH()
ENDMACRO()
